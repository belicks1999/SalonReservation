...
function About() {
  return (
    <div className="text-center mt-24 pb-32 border-b border-black">
      <div className="px-6 lg:px-36 flex flex-wrap justify-center items-center ">
        ...
        <div className="w-full lg:w-1/2 p-5 flex justify-center items-center ">
          <img className="w-80 lg:w-96 " src={aboutImage} alt="About" />
        </div>

        {/* About Text */}
        <div className="w-full lg:w-1/2 p-5">
          <h1 className="text-3xl lg:text-5xl font-bold font-serif mb-5 lg:text-left">About Us</h1>
