...
function Services() {
  ...
  return (
    <div className="mt-24 px-6 lg:px-36 flex flex-col items-center pb-32 border-b border-black">
      <h1 className="text-center text-3xl lg:text-4xl font-bold mb-20">Our Services</h1>
      <div className="flex flex-wrap justify-center w-full gap-8 text-center">
        
        <div className="w-full sm:w-72 md:w-80 lg:w-96 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
        <motion.div
        ...
        <div className=" overflow-hidden w-full sm:w-72 md:w-80 lg:w-96 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <motion.div
          whileHover={{scale:1.1}}
          transition={{duration:0.3}}>
